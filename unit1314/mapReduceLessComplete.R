...
#Now, suppose we want to "reduce" this to a single sentance with commas
redOut = do.call(...,c(mapOut,sep=...))
...
#   We can do this with two map/reduce steps.  It will be more readable if we 
#   make the map function have more general terminology, referring to a "matObj" and "vecObj" 
#   instead of, say, XtXinv and X_0
###

# Objects we would have saved from earlier computations:
sSq    = 1
XtXinv = solve(t(X) %*% X)
